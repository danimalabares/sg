...
\begin{idea8}{Projeto final}\leavevmode
...
\begin{idea4}{Lema (Exercício)}\leavevmode
...
\begin{idea8}{Ou seja, $c_2$ mede a segunda obstrução}\leavevmode
\end{idea8}
...
\begin{idea5}{Consequencia}\leavevmode
